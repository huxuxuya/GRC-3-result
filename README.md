...
| Case 02: Settle-drop / negative balance | Included after independent review of the affected set. The latest committee discussion did not create a clear mandate to remove this case from Proposal #3; broader rule questions are deferred to the next GRC task cycle. | `1075.336150923 GNK` | [`gonkavip/unclaimed`](https://github.com/gonkavip/unclaimed), [`Dolper/GRC-case-2-settle-dropped`](https://github.com/Dolper/GRC-case-2-settle-dropped) |
...
| Case 05: Kimi restitution aggregate, epochs 265-276 | Reviewed and rejected as a single aggregate compensation claim for the current Proposal #3 package. Used in this proposal only as already-paid overlap evidence and as bounty-eligible investigation/review work. GRC acknowledges open questions around the broader impact of the Epoch 265 attack; in the next GRC task cycle, this case should receive additional deeper review to determine whether any specific miner losses can be recognized and compensated separately. | `0.000000000 GNK` | [`@v****n/gonka-kimi-restitution`](https://github.com/votkon/gonka-kimi-restitution), [`huxuxuya 265 attack review`](https://huxuxuya.github.io/265-attack/) |
